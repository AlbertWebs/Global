...
<head>
    <meta charset="utf-8">
    <title>M-Pesa Payments Report - {{ $dateFrom }} to {{ $dateTo }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        ...
        <div class="subtitle">M-Pesa Payments Report</div>
        <div class="period">
            @if($dateFrom && $dateTo)
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                @endforeach
                <tr class="total-row">
                    <td colspan="5" class="text-right" style="font-size: 12px;">TOTAL M-PESA PAYMENTS:</td>
    ...
    @else
    <div class="no-data">
        <p>No M-Pesa payments found for the selected period.</p>
    </div>
    @endif
