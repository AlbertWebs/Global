...
<head>
    <meta charset="utf-8">
    <title>Cash Payments Report - {{ $dateFrom }} to {{ $dateTo }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        ...
        <div class="subtitle">Cash Payments Report</div>
        <div class="period">
            @if($dateFrom && $dateTo)
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                @endforeach
                <tr class="total-row">
                    <td colspan="5" class="text-right" style="font-size: 12px;">TOTAL CASH PAYMENTS:</td>
    ...
    @else
    <div class="no-data">
        <p>No cash payments found for the selected period.</p>
    </div>
    @endif
